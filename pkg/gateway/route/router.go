...
import (
	...
	storageclient "github.com/a1y/doc-formatter/pkg/gateway/clients/storage"
	authhandler "github.com/a1y/doc-formatter/pkg/gateway/handler/auth"
	storagehandler "github.com/a1y/doc-formatter/pkg/gateway/handler/storage"
	authmanager "github.com/a1y/doc-formatter/pkg/gateway/manager/auth"
	storagemanager "github.com/a1y/doc-formatter/pkg/gateway/manager/storage"
	"github.com/a1y/doc-formatter/pkg/gateway/middleware"
	logutil "github.com/a1y/doc-formatter/pkg/gateway/util/logging"
...
func NewRouter(config *gateway.Config) (*gin.Engine, error) {
	...
	r.Use(middleware.APILoggerMiddleware(config.Logging))
