...
func TestDocFormatterVersionNormal(t *testing.T) {
	mockey.PatchConvey("test doc-formatter version normal", t, func() {
		mockGetHeadHash()
...
func TestDocFormatterVersionReturnError(t *testing.T) {
	tests := []struct {
		name        string
		specialMock func()
	}{
...
func TestDocFormatterVersionNotHeadTag(t *testing.T) {
	mockey.PatchConvey("test doc-formatter version not head tag", t, func() {
		mockGetHeadHash()
		mockGetHeadHashShort()
		mockGetLatestTag()
		mockNewVersion()
